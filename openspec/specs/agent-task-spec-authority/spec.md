# agent-task-spec-authority Specification

## Purpose
This specification defines the canonical agent-task-spec-authority behavior, authority boundaries, compatibility rules, and fail-closed scenarios synchronized from the implemented T0005 delivery sequence.
