# agent-runtime-receipt-checkpoint-contract Specification

## Purpose
This specification defines the canonical agent-runtime-receipt-checkpoint-contract behavior, authority boundaries, compatibility rules, and fail-closed scenarios synchronized from the implemented T0005 delivery sequence.
