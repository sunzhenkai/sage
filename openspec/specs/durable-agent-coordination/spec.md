# durable-agent-coordination Specification

## Purpose
This specification defines the canonical durable-agent-coordination behavior, authority boundaries, compatibility rules, and fail-closed scenarios synchronized from the implemented T0005 delivery sequence.
