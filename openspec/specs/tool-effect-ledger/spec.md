# tool-effect-ledger Specification

## Purpose
This specification defines the canonical tool-effect-ledger behavior, authority boundaries, compatibility rules, and fail-closed scenarios synchronized from the implemented T0005 delivery sequence.
